...
cp "$project_dir/src/background.js" "$project_dir/src/backup.js" "$project_dir/src/features.js" "$project_dir/src/export.js" "$project_dir/src/search.js" "$project_dir/src/shortcut.js" "$project_dir/src/popup.js" "$project_dir/src/options.js" "$project_dir/src/onboarding.js" "$project_dir/src/shared.css" "$staging_dir/src/"
cp "$project_dir/src/library.js" "$staging_dir/src/"
